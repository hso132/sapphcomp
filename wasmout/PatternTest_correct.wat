(module 
  ...
  (func $PatternTest_listToString (param i32) (result i32) (local i32 i32)
    get_local 0
    set_local 1
    get_local 1
    set_local 2
  ...
  (export "PatternTest_main" (func $PatternTest_main))
  (func $PatternTest_main (local i32 i32 i32)
    get_global 0
    set_local 1
    get_global 0
    i32.const 12
